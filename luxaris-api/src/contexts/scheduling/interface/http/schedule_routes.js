...
function create_schedule_routes(schedule_service, auth_middleware) {
  ...
  router.get('/', async (req, res, next) => {
    try {
      ...
      // Extract filters
      const filters = {};
      if (req.query.post_variant_id) filters.post_variant_id = req.query.post_variant_id;
      if (req.query.channel_connection_id) filters.channel_connection_id = req.query.channel_connection_id;
      if (req.query.status) filters.status = req.query.status;
      if (req.query.run_at_from) filters.run_at_from = req.query.run_at_from;
      if (req.query.run_at_to) filters.run_at_to = req.query.run_at_to;
